...
class CustomTaxonomyController extends BaseController
{
	...
	{
		$options = get_option( 'alecaddd_plugin_tax' );

		$this->taxonomies = array();

		foreach( $options as $option ){

			#$this->al_print_r( $option, true );
			...
			$this->taxonomies[] = array(
				'hierarchical' => $option['hierarchical'] ? true : false,
				'labels' => $labels,
				'show_ui' => true,
	...
	public function registerCustomTaxonomy()
	{
		foreach( $this->taxonomies as $taxonomy ){
			$objects = $taxonomy['objects'] ? array_keys( $taxonomy['objects'] ) : null;
